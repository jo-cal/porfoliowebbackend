...
import com.porfolio1.backend.service.iProyectoService;
...
public class ProyectoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Proyecto> addProyecto(@PathVariable("id") Long id) {
        Proyecto proyecto = proyectoService.buscarProyectos(id);
    ...
    public Proyecto updateProyecto(@PathVariable long id, @RequestBody Proyecto proyectoDetails) {
        ...
        proyectoService.saveProyecto(updateProyecto);
